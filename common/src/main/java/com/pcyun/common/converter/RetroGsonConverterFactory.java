package com.pcyun.common.converter;

import com.google.gson.Gson;
import com.google.gson.TypeAdapter;
import com.google.gson.reflect.TypeToken;
import com.pcyun.common.bean.IApiResult;
...
public class RetroGsonConverterFactory<ApiResultType extends IApiResult> extends Converter.Factory {
    ...
    public static <ApiResultType extends IApiResult> @NotNull RetroGsonConverterFactory create(Gson gson,
                                                                                               Class<ApiResultType> apiClass) {
